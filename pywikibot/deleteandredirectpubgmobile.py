...
This script can be used to delete and redirect to another wiki.
...
class DeletionReplaceRobot(MultipleSitesBot, CurrentPageBot):
    ...
    def __init__(self, generator, summary, **kwargs):
        ...
        @param summary: the reason for the deletion
        ...
        super(DeletionReplaceRobot, self).__init__(generator=generator, **kwargs)
