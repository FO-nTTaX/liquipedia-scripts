...
for ($i = 1; $i <= $numberofteams; $i++) {
	...
	for ($j = 1; $j <= $numberofteams + 1; $j++) {
		if ($i == $j) {
			...
			echo '--&gt;{{#if:{{{player'.$j.'|}}}|{{#if:{{{'.$i.'vs'.$j.'result|}}}{{{'.$i.'vs'.$j.'resultvs|}}}|&lt;td class="crosstable-bgc-r{{{'.$i.'vs'.$j.'result|}}}-r{{{'.$i.'vs'.$j.'resultvs|}}} bracket-game"&gt;&lt;div&gt;\'\'\'{{{'.$i.'vs'.$j.'result}}}-{{{'.$i.'vs'.$j.'resultvs}}}\'\'\'&lt;/div&gt;{{#if:{{{'.$i.'vs'.$j.'details|}}}|&lt;div class="bracket-game-details" style="margin-left:{{#expr:5+{{{cell-width|100}}}}}px;"&gt;{{BracketMatchPlayers|{{#if:{{{player'.$i.'|}}}|{{{player'.$i.'}}}|TBD}}|{{{player'.$i.'race|}}}|{{#if:{{{player'.$j.'|}}}|{{{player'.$j.'}}}|TBD}}|{{{player'.$j.'race|}}}}} {{{'.$i.'vs'.$j.'details}}}&lt;/div&gt;}}&lt;/td&gt;|&lt;td&gt;&lt;/td&gt;}}}}&lt;!--<br>';
		} elseif ($i > $j) {
			echo '--&gt;{{#ifeq:{{{doublerounded}}}|true|{{#if:{{{'.$i.'vs'.$j.'result|}}}{{{'.$i.'vs'.$j.'resultvs|}}}|&lt;td class="crosstable-bgc-r{{{'.$i.'vs'.$j.'result|}}}-r{{{'.$i.'vs'.$j.'resultvs|}}} bracket-game"&gt;&lt;div&gt;\'\'\'{{{'.$i.'vs'.$j.'result}}}-{{{'.$i.'vs'.$j.'resultvs}}}\'\'\'&lt;/div&gt;{{#if:{{{'.$i.'vs'.$j.'details|}}}|&lt;div class="bracket-game-details" style="margin-left:{{#expr:5+{{{cell-width|100}}}}}px;"&gt;{{BracketMatchPlayers|{{#if:{{{player'.$i.'|}}}|{{{player'.$i.'}}}|TBD}}|{{{player'.$i.'race|}}}|{{#if:{{{player'.$j.'|}}}|{{{player'.$j.'}}}|TBD}}|{{{player'.$j.'race|}}}}} {{{'.$i.'vs'.$j.'details}}}&lt;/div&gt;}}&lt;/td&gt;|&lt;td&gt;&lt;/td&gt;}}|{{#if:{{{'.$j.'vs'.$i.'result|}}}{{{'.$j.'vs'.$i.'resultvs|}}}|&lt;td class="crosstable-bgc-r{{{'.$j.'vs'.$i.'resultvs|}}}-r{{{'.$j.'vs'.$i.'result|}}} bracket-game"&gt;&lt;div&gt;\'\'\'{{{'.$j.'vs'.$i.'resultvs}}}-{{{'.$j.'vs'.$i.'result}}}\'\'\'&lt;/div&gt;{{#if:{{{'.$j.'vs'.$i.'details|}}}|&lt;div class="bracket-game-details" style="margin-left:{{#expr:5+{{{cell-width|100}}}}}px;"&gt;{{BracketMatchPlayers|{{#if:{{{player'.$j.'|}}}|{{{player'.$j.'}}}|TBD}}|{{{player'.$j.'race|}}}|{{#if:{{{player'.$i.'|}}}|{{{player'.$i.'}}}|TBD}}|{{{player'.$i.'race|}}}}} {{{'.$j.'vs'.$i.'details}}}&lt;/div&gt;}}&lt;/td&gt;|&lt;td&gt;&lt;/td&gt;}}}}&lt;!--<br>';
		}
	}
	echo '--&gt;&lt;/tr&gt;}}&lt;!--'."<br>";
}
