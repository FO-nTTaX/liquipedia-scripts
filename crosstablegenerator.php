...
for ($i = 1; $i <= $numberofteams; $i++) {
   ...
   for ($j = 1; $j <= $numberofteams; $j++) {
      ...
      if ($i < $j) {
         echo '--&gt;{{#if:{{{team'.$j.'|}}}|{{#if:{{{'.$i.'vs'.$j.'result|}}}{{{'.$i.'vs'.$j.'resultvs|}}}|&lt;td style="padding:0;background-color:#{{#ifeq:{{{'.$i.'vs'.$j.'result}}}|{{{'.$i.'vs'.$j.'resultvs}}}|ffffff|{{#ifeq:{{#expr:{{{'.$i.'vs'.$j.'result}}}&gt;{{{'.$i.'vs'.$j.'resultvs}}}}}|1|ccffcc|ffcccc}}}}"&gt;\'\'\'{{#if:{{{'.$i.'vs'.$j.'link|}}}|[[{{{'.$i.'vs'.$j.'link}}}|&lt;span style="margin:0;width:100%;height:100%;display:block"&gt;{{#if:{{{'.$i.'vs'.$j.'abbr|}}}|&lt;abbr title=&quot;{{{'.$i.'vs'.$j.'abbr}}}&quot;&gt;{{{'.$i.'vs'.$j.'result}}}-{{{'.$i.'vs'.$j.'resultvs}}}&lt;/abbr&gt;|{{{'.$i.'vs'.$j.'result}}}-{{{'.$i.'vs'.$j.'resultvs}}}}}&lt;/span&gt;]]|{{#if:{{{'.$i.'vs'.$j.'abbr|}}}|&lt;abbr title=&quot;{{{'.$i.'vs'.$j.'abbr}}}&quot;&gt;{{{'.$i.'vs'.$j.'result}}}-{{{'.$i.'vs'.$j.'resultvs}}}&lt;/abbr&gt;|{{{'.$i.'vs'.$j.'result}}}-{{{'.$i.'vs'.$j.'resultvs}}}}}}}\'\'\'&lt;/td&gt;|&lt;td&gt;&lt;/td&gt;}}}}&lt;!--<br>';
      }
      if ($i > $j) {
         echo '--&gt;{{#ifeq:{{{doublerounded}}}|true|{{#if:{{{'.$i.'vs'.$j.'result|}}}{{{'.$i.'vs'.$j.'resultvs|}}}|&lt;td style="padding:0;background-color:#{{#ifeq:{{{'.$i.'vs'.$j.'result}}}|{{{'.$i.'vs'.$j.'resultvs}}}|ffffff|{{#ifeq:{{#expr:{{{'.$i.'vs'.$j.'result}}}&gt;{{{'.$i.'vs'.$j.'resultvs}}}}}|1|ccffcc|ffcccc}}}}"&gt;\'\'\'{{#if:{{{'.$i.'vs'.$j.'link|}}}|[[{{{'.$i.'vs'.$j.'link}}}|&lt;span style="margin:0;width:100%;height:100%;display:block"&gt;{{#if:{{{'.$i.'vs'.$j.'abbr|}}}|&lt;abbr title=&quot;{{{'.$i.'vs'.$j.'abbr}}}&quot;&gt;{{{'.$i.'vs'.$j.'result}}}-{{{'.$i.'vs'.$j.'resultvs}}}&lt;/abbr&gt;|{{{'.$i.'vs'.$j.'result}}}-{{{'.$i.'vs'.$j.'resultvs}}}}}&lt;/span&gt;]]|{{#if:{{{'.$i.'vs'.$j.'abbr|}}}|&lt;abbr title=&quot;{{{'.$i.'vs'.$j.'abbr}}}&quot;&gt;{{{'.$i.'vs'.$j.'result}}}-{{{'.$i.'vs'.$j.'resultvs}}}&lt;/abbr&gt;|{{{'.$i.'vs'.$j.'result}}}-{{{'.$i.'vs'.$j.'resultvs}}}}}}}\'\'\'&lt;/td&gt;|&lt;td&gt;&lt;/td&gt;}}|{{#if:{{{'.$j.'vs'.$i.'result|}}}{{{'.$j.'vs'.$i.'resultvs|}}}|&lt;td style="padding:0;background-color:#{{#ifeq:{{{'.$j.'vs'.$i.'result}}}|{{{'.$j.'vs'.$i.'resultvs}}}|ffffff|{{#ifeq:{{#expr:{{{'.$j.'vs'.$i.'result}}}&lt;{{{'.$j.'vs'.$i.'resultvs}}}}}|1|ccffcc|ffcccc}}}}"&gt;\'\'\'{{#if:{{{'.$j.'vs'.$i.'link|}}}|[[{{{'.$j.'vs'.$i.'link}}}|&lt;span style="margin:0;width:100%;height:100%;display:block"&gt;{{#if:{{{'.$j.'vs'.$i.'abbr|}}}|&lt;abbr title=&quot;{{{'.$j.'vs'.$i.'abbr}}}&quot;&gt;{{{'.$j.'vs'.$i.'result}}}-{{{'.$j.'vs'.$i.'resultvs}}}&lt;/abbr&gt;|{{{'.$j.'vs'.$i.'result}}}-{{{'.$j.'vs'.$i.'resultvs}}}}}&lt;/span&gt;]]|{{#if:{{{'.$j.'vs'.$i.'abbr|}}}|&lt;abbr title=&quot;{{{'.$j.'vs'.$i.'abbr}}}&quot;&gt;{{{'.$j.'vs'.$i.'resultvs}}}-{{{'.$j.'vs'.$i.'result}}}&lt;/abbr&gt;|{{{'.$j.'vs'.$i.'resultvs}}}-{{{'.$j.'vs'.$i.'result}}}}}}}\'\'\'&lt;/td&gt;|&lt;td&gt;&lt;/td&gt;}}}}&lt;!--<br>';
      }
   }
   echo '--&gt;&lt;/tr&gt;}}&lt;!--'."<br>";
}
