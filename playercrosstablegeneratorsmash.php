...
for ($i = 1; $i <= $numberofteams; $i++) {
   ...
   echo '--&gt;&lt;th style="min-width:{{{cell-width|100}}}px;"&gt;{{player|{{{player'.$i.'}}}|char={{{player'.$i.'char|}}}|flag={{{player'.$i.'flag|}}}|link={{{player'.$i.'link|}}}}}{{#if:{{{player'.$i.'b|}}}|&lt;br&gt;{{player|{{{player'.$i.'b}}}|char={{{player'.$i.'bchar|}}}|flag={{{player'.$i.'bflag|}}}|link={{{player'.$i.'blink|}}}}}}}&lt;/th&gt;&lt;!--'."<br>";
   for ($j = 1; $j <= $numberofteams + 1; $j++) {
      if ($i == $j) {
         ...
         echo '--&gt;{{#if:{{{player'.$j.'|}}}|{{#if:{{{'.$i.'vs'.$j.'result|}}}{{{'.$i.'vs'.$j.'resultvs|}}}|&lt;td class="crosstable-bgc-r{{{'.$i.'vs'.$j.'result|}}}-r{{{'.$i.'vs'.$j.'resultvs|}}} bracket-game"&gt;&lt;div&gt;\'\'\'{{{'.$i.'vs'.$j.'result}}}-{{{'.$i.'vs'.$j.'resultvs}}}\'\'\'&lt;/div&gt;{{#if:{{{'.$i.'vs'.$j.'details|}}}|{{BracketMatchPlayers|{{#expr:5+{{{cell-width|100}}}}}|{{#if:{{{player'.$i.'|}}}|{{{player'.$i.'}}}{{#if:{{{player'.$i.'b|}}}|&lt;br&gt;{{{player'.$i.'b}}}}}|TBD}}|{{#if:{{{player'.$j.'|}}}|{{{player'.$j.'}}}{{#if:{{{player'.$j.'b|}}}|&lt;br&gt;{{{player'.$j.'b}}}}}|TBD}}}} {{{'.$i.'vs'.$j.'details}}}}}&lt;/td&gt;|&lt;td&gt;&lt;/td&gt;}}}}&lt;!--<br>';
      } elseif ($i > $j) {
         echo '--&gt;{{#ifeq:{{{doublerounded}}}|true|{{#if:{{{'.$i.'vs'.$j.'result|}}}{{{'.$i.'vs'.$j.'resultvs|}}}|&lt;td class="crosstable-bgc-r{{{'.$i.'vs'.$j.'result|}}}-r{{{'.$i.'vs'.$j.'resultvs|}}} bracket-game"&gt;&lt;div&gt;\'\'\'{{{'.$i.'vs'.$j.'result}}}-{{{'.$i.'vs'.$j.'resultvs}}}\'\'\'&lt;/div&gt;{{#if:{{{'.$i.'vs'.$j.'details|}}}|{{BracketMatchPlayers|{{#expr:5+{{{cell-width|100}}}}}|{{#if:{{{player'.$i.'|}}}|{{{player'.$i.'}}}{{#if:{{{player'.$i.'b|}}}|&lt;br&gt;{{{player'.$i.'b}}}}}|TBD}}|{{#if:{{{player'.$j.'|}}}|{{{player'.$j.'}}}{{#if:{{{player'.$j.'b|}}}|&lt;br&gt;{{{player'.$j.'b}}}}}|TBD}}}} {{{'.$i.'vs'.$j.'details}}}}}&lt;/td&gt;|&lt;td&gt;&lt;/td&gt;}}|{{#if:{{{'.$j.'vs'.$i.'result|}}}{{{'.$j.'vs'.$i.'resultvs|}}}|&lt;td class="crosstable-bgc-r{{{'.$j.'vs'.$i.'resultvs|}}}-r{{{'.$j.'vs'.$i.'result|}}} bracket-game"&gt;&lt;div&gt;\'\'\'{{{'.$j.'vs'.$i.'resultvs}}}-{{{'.$j.'vs'.$i.'result}}}\'\'\'&lt;/div&gt;{{#if:{{{'.$j.'vs'.$i.'details|}}}|{{BracketMatchPlayers|{{#expr:5+{{{cell-width|100}}}}}|{{#if:{{{player'.$j.'|}}}|{{{player'.$j.'}}}{{#if:{{{player'.$j.'b|}}}|&lt;br&gt;{{{player'.$j.'b}}}}}|TBD}}|{{#if:{{{player'.$i.'|}}}|{{{player'.$i.'}}}{{#if:{{{player'.$i.'b|}}}|&lt;br&gt;{{{player'.$i.'b}}}}}|TBD}}}} {{{'.$j.'vs'.$i.'details}}}}}&lt;/td&gt;|&lt;td&gt;&lt;/td&gt;}}}}&lt;!--<br>';
      }
   }
   echo '--&gt;&lt;/tr&gt;}}&lt;!--'."<br>";
}
echo '--&gt;&lt;tr&gt;&lt;th&gt;&lt;/th&gt;&lt;!--<br>';
for ($i = 1; $i <= $numberofteams; $i++) {
   echo '--&gt;{{#if:{{{player'.$i.'|}}}|&lt;th style="min-width:{{{cell-width|100}}}px;"&gt;{{player|{{{player'.$i.'}}}|char={{{player'.$i.'char|}}}|flag={{{player'.$i.'flag|}}}|link={{{player'.$i.'link|}}}}}{{#if:{{{player'.$i.'b|}}}|&lt;br&gt;{{player|{{{player'.$i.'b}}}|char={{{player'.$i.'bchar|}}}|flag={{{player'.$i.'bflag|}}}|link={{{player'.$i.'blink|}}}}}}}&lt;/th&gt;}}&lt;!--<br>';
}
